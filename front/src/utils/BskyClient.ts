...
export default class BskyClient {
    ...
    public init(service: string, session: AtpSessionData) {
        ...
        BskyClient._agent.resumeSession(session);
    ...
    public getTimeline = async (params: AppBskyFeedGetTimeline.QueryParams): Promise<AppBskyFeedGetTimeline.Response> => {
     ...
     * @returns 
     */
    public getFeed = async (uri: string): Promise<AppBskyFeedGetPostThread.Response> => {
     ...
     * @returns 
     */
    public postFeed = async (post: AppBskyFeedPost.Record): Promise<{uri: string, cid: string}> => {
